...
def menu():
			...
			if xd in ['1','01']:
				clear()
				print('\033[ mPut file example:  /sdcard/LION.txt  etc..')
				linex()
...
def pak():
		...
		with tred(max_workers=30) as Hamza:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					passlist = [psx,ids,'600700','afghanistan','afghan12345','khan12345','khan123','500500','400500','10002000','۱۲۳۴۵۶۷۸۹','afghan123','kabul123','khankhan']
				elif pcs in ['3','03']:
